...
export default function CardsPart() {
  const transformFrameworkName = (framework: string): string => {
    const frameworkUrls: { [key: string]: string } = {
      ...
      xamarinIos: "/7.6.13/sdks/xamarin/ios/add-sdk",
      xamarinAndroid: "/7.6.13/sdks/xamarin/android/add-sdk",
      xamarinForms: "/7.6.13/sdks/xamarin/forms/add-sdk",
  ...
  const transformFrameworkNameId = (framework: string): string => {
    const frameworkUrls: { [key: string]: string } = {
      ...
      xamarinIos: "/7.6.13/sdks/xamarin/id-capture/get-started/",
      xamarinAndroid: "/7.6.13/sdks/xamarin/android/id-capture/get-started/",
      xamarinForms: "/7.6.13/sdks/xamarin/forms/id-capture/get-started/",
    };
