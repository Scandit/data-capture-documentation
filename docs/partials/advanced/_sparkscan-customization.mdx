...
<p align="center">
  <img src="/static/img/sparkscan/SparkScanSelfScanning.png" alt="SparkScan Customized on Mobile" /><br></br>Customized Self-Scanning application with custom FAB button and preview expanded by default
</p>

<p align="center">
  <img src="/static/img/sparkscan/SparkScanmPOS.png" alt="SparkScan Customized on Tablet" /><br></br>Customized mPOS application using the existing scan button to trigger the scanner
</p>
...
<p align="center">
  <img src="/static/img/sparkscan/toolbar.png" alt="Toolbar without Scanning Modes" /><br></br>The standard toolbar without additional scanning modes added.
</p>

<p align="center">
  <img src="/static/img/sparkscan/toolbar-buttons.png" alt="Toolbar with Scanning Modes" /><br></br>The toolbar with MatrixScan Find and MatrixScan Count buttons.
</p>
