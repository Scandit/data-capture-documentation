...
<p align="center">
  <img src="/img/sparkscan/SparkScanSelfScanning.png" alt="SparkScan Customized on Mobile" /><br></br>Customization example in a Self Scanning application, with a custom FAB button and preview expanded by default.
</p>

<p align="center">
  <img src="/img/sparkscan/SparkScanmPOS.png" alt="SparkScan Customized on Tablet" /><br></br>Customization example in an mPOS application, using the existing scan button to trigger the scanner.
</p>
