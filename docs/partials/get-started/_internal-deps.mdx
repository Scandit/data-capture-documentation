...
| ----------- | ----------- | ----------- |
| *ScanditCaptureCore*      | *ScanditDesign* | None |
| *ScanditDesign*           | None | None |
| *ScanditBarcodeCapture*   | *ScanditCaptureCore* <br/>*ScanditDesign* | None |
| *ScanditParser*           | None | None |
| *ScanditLabelCapture*     | *ScanditCaptureCore* <br/>*ScanditBarcodeCapture* | *ScanditLabelCaptureText* <br/>*ScanditPriceLabel* |
