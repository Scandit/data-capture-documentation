...
:::tip
If an error message occurs appears on screen after initialization, review the [Context Status Codes](https://docs.scandit.com/data-capture-sdk/react-native/core/api/context-status.html#status-codes) to learn more about the specific reason.
:::
...
<Tabs defaultValue="ts" values={[
	...
	const context = useMemo(() => {
		return DataCaptureContext.initialize(
