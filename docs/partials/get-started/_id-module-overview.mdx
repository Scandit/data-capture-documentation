...
| *ScanditIdCaptureBackend* | Extract data from visual inspection zones (for example, the front of IDs and driver licenses, or the human-readable data on Passport) |
