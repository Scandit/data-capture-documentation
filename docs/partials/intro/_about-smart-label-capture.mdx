...
* The content of texts or barcodes (for example, a serial number always having a fixed number of digits)
* The barcode symbology (for example, QR code, UPC, EAN13, etc.)
* The relative position of fields
* Textual context, that is, text that is close to the field and describes it's meaning (for example, "BEST BEFORE" next to an expiry date text)
