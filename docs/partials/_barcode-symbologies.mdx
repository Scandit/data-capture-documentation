...
* Used for tickets in the transport industries, for example, railway companies.
...
* Australian Post manages the Guide to Printing the 4-State Barcode specification (latest revision March 16, 2012).
