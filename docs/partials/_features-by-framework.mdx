...
| Feature | iOS | Android | Cordova | React Native | Flutter | Capacitor | Titanium | Web  | .NET for iOS | .NET for Android |
|-----------------|---------------------------------------------|-----|---------|---------|---------------|---------|-----------|----------|------|--------------|
|         | 6.0       | 6.0 | 8.2     | 6.5     | 7.2          | 8.0    | n/a       | 7.2      | n/a  | 8.2          | 8.1              |

### UI

| Feature                                         | iOS | Android | Cordova | React Native | Flutter | Capacitor | Titanium | Web  | .NET for iOS | .NET for Android |
|-------------------------------------------------|-----|---------|---------|--------------|---------|-----------|----------|------|--------------|------------------|
| Basic Overlay (Form Highlight)              | 6.0 | 6.0     | 8.2     | 6.5          | n/a     | n/a       | n/a      | n/a  | 8.2          | 8.1              |

### Feedback    

| Feature                                         | iOS | Android | Cordova | React Native | Flutter | Capacitor | Titanium | Web  | .NET for iOS | .NET for Android |
|-------------------------------------------------|-----|---------|---------|--------------|---------|-----------|----------|------|--------------|------------------|
| Manual Beep on Scan                         | 6.0 | 6.0     | 8.2     | 6.5          | n/a     | n/a       | n/a      | n/a  | 8.2          | 8.1              |
| Manual Vibrate on Scan                      | 6.0 | 6.0     | 8.2     | 6.5          | n/a     | n/a       | n/a      | n/a  | 8.2          | 8.1              |
