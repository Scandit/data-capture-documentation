...
These platforms are based on the native platforms and therefore the requirements of native platforms apply as well. If a framework has stricter requirements (for example, it only supports newer versions of Android/iOS) it is explicitly stated.
