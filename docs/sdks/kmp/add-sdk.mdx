...
- A Kotlin Multiplatform project built with **Kotlin 2.3.21 or higher** and Gradle 8.14 or higher, optionally using Compose Multiplatform 1.8.0 or higher (see [Compose Multiplatform support](#compose-multiplatform-support) below). Earlier Kotlin 2.x releases are not supported — see [System Requirements](./system-requirements.mdx) for why.
