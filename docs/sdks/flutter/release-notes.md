...
- [`BarcodeTrackingAdvancedOverlay`](https://docs.scandit.com/data-capture-sdk/flutter/barcode-capture/api/ui/barcode-batch-advanced-overlay.html#) and [`BarcodeTrackingAdvancedOverlayListener`](https://docs.scandit.com/data-capture-sdk/flutter/barcode-capture/api/ui/barcode-batch-advanced-overlay-listener.html#) have been re-added, with the following changes: 
...
* Deprecated Legacy value of the [`BarcodeTrackingBasicOverlayStyle`](https://docs.scandit.com/data-capture-sdk/flutter/barcode-capture/api/ui/barcode-batch-basic-overlay.html#enum-scandit.datacapture.barcode.batch.ui.BarcodeTrackingBasicOverlayStyle).
