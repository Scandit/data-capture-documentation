...
* MatrixScan Sequence: `initialOrderOnShelf` and `initialOrderOnTray` resume scanning from a previous session (already available since 8.5.1).
...
Find earlier versions in the [release notes section of version 7](/7.6.14/sdks/android/release-notes)