...
settings.scanningBehavior = .single

let sparkViewSettings = SparkScanViewSettings()
sparkViewSettings.scanningMode = .default
sparkViewSettings.previewBehavior = .default

let sparkView = SparkScanView(settings: sparkViewSettings)
```
...
settings.scanningBehavior = .single
sparkViewSettings.scanningMode = .default
sparkViewSettings.previewBehavior = .persistent
```
...
```swift
settings.scanningBehavior = .continuous
sparkViewSettings.scanningMode = .default
sparkViewSettings.previewBehavior = .default
```
...
```swift
settings.scanningBehavior = .single
sparkViewSettings.scanningMode = .target
sparkViewSettings.previewBehavior = .default
```
