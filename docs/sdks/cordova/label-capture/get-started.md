...
```ts
import { CapturedLabel, LabelCaptureListener } from 'scandit-cordova-datacapture-label';
import type { LabelCapture, LabelCaptureSession } from 'scandit-cordova-datacapture-label';
...
import { LabelCapture, LabelCaptureBasicOverlay } from "scandit-cordova-datacapture-label"
