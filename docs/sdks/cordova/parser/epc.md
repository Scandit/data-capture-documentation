...
- [Parser Get Started](/sdks/cordova/parser/get-started)
- [Parser Data Format API](https://docs.scandit.com/data-capture-sdk/cordova/parser/api/parser-data-format.html)
