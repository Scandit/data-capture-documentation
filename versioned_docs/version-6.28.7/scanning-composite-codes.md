...
The Scandit Data Capture SDK supports scanning of all [GS1 Composite Codes](/docs/barcode-symbologies.md#gs1-composite-codes). The specification defines three different types: A, B and C.
