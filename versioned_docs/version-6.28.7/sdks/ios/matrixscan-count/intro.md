...
:::note
MatrixScan Count does not include a UI for reviewing the scan list, but a recommended UI for this process can be seen in our [Receiving Sample](https://github.com/Scandit/datacapture-ios-samples).
:::

## Prerequisites

- [Installed the Scandit Data Capture SDK](/sdks/ios/add-sdk.md).
