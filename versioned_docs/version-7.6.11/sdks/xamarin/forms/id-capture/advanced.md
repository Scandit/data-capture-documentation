...
By default, data extracted from documents is anonymized according to local regulations. See [Anonymized Documents](/sdks/xamarin/forms/id-capture/supported-documents.md#anonymized-documents) for more information.
...
By default, a new instance of [IdCaptureSettings](https://docs.scandit.com/7.6/data-capture-sdk/xamarin.forms/id-capture/api/id-capture-settings.html#class-scandit.datacapture.id.IdCaptureSettings) creates a single-sided scanner type with no accepted or rejected documents. 
...
* [AAMVABarcodeVerifier](https://docs.scandit.com/7.6/data-capture-sdk/xamarin.forms/id-capture/api/aamva-barcode-verifier.html#class-scandit.datacapture.id.AamvaBarcodeVerifier): Validates the authenticity of the document by scanning the barcode on the back.
