...
:::note
MatrixScan Count does not include a UI for reviewing the scan list; however a recommended UI for this process can be seen in our [Receiving Sample](https://github.com/Scandit/datacapture-android-samples).
:::
