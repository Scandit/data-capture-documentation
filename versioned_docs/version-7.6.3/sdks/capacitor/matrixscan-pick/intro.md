...
MatrixScan Pick is implemented through functionality provided by [`BarcodePick`](https://docs.scandit.com/7.6/data-capture-sdk/capacitor/barcode-capture/api/barcode-pick.html).
