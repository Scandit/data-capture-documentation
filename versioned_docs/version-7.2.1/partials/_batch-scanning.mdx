...
**Available For:** [iOS](/sdks/ios/matrixscan-check/intro.md), [Android](/sdks/android/matrixscan-check/intro.md), [React Native](/sdks/react-native/matrixscan-check/intro.md), [Flutter](/sdks/flutter/matrixscan-check/intro.md), [Web](/sdks/web/matrixscan-check/intro.md), .NET ([iOS](/sdks/net/ios/matrixscan-check/intro.md), [Android](/sdks/net/android/matrixscan-check/intro.md))
